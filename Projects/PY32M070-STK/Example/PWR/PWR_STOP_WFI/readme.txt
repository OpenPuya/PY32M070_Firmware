...
This sample demonstrates the stop mode with GPIO interrupt wake-up feature.
================================================================================
测试环境：
测试用板：PY32M070_STK
MDK版本： 5.28
...
2. The LED is on, press the button, the LED turns off, and "STOP MODE!" is 
   printed on the serial port, entering the stop mode.
