...
It also generates their complementary signals. It also generates their 
...
1. 编译下载程序到MCU，并运行
2. 将PA6引脚接低电平。
3. 使用逻辑分析仪观察引脚PA7/PA8/PA9/PA10/PB4/PB5的波形；
...
3.Use a logic analyzer to observe the waveforms on pins PA7/PA8/PA9/PA10/PB4/PB5.
